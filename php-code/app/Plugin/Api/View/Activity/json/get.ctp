<?php
    ...
    switch ($data['Activity']['item_type']) {
        case '' :
            $activityMore = $activityText = $title = '';
            ...
            if($data['Activity']['action'] == 'wall_post_share' || $data['Activity']['action'] == 'wall_post_link_share'  ) :
                ...
                if ($data['Activity']['target_id']): 
                    ...
                    if ($show_subject): //echo '<pre>';print_r($show_subject);die;
                        $type = 'share_user';
            ...
            if($type == 'share_user') $items = array_merge($items,$activityMore);
            break;
        ...
        case 'Photo_Photo':  
            ...
            $userAlbum = $feedTitle = $activityText = '';
            if($data['Activity']['type'] == 'User' || $data['Activity']['type'] == 'user' ) : 
                ...
                if($data['Activity']['action'] == 'photo_item_detail_share'):
                    ...
                    if (isset($data['Activity']['parent_id']) && $data['Activity']['parent_id']): 
                            ...
                            $target = array(
                            'url' => FULL_BASE_URL . $photo['User']['moo_href'],
                            'id' =>  $photo['User']['id'],
                    ...
                    if ($data['Activity']['target_id']): 
                            ...
                            if ($show_subject):
                                ...
                                $userAlbum = array (
                                    'user_url' => FULL_BASE_URL . $photo['User']['moo_href'],
            ...
            if($data['Activity']['action'] == 'photos_add') :
                    ...
                    if($type == 'share_user') $items = array_merge($items,$userAlbum);
        ...
        case 'Photo_Album':  
            ...
            $userAlbum = $url = $feedTitle = $activityText = '' ;
            ...
            if($data['Activity']['type'] == 'User' || $data['Activity']['type'] == 'user' ) : 
                ...
                if($data['Activity']['action'] == 'album_item_detail_share'):
                        ...
                        if (isset($data['Activity']['parent_id']) && $data['Activity']['parent_id']): 
                            ...
                            $target = array(
                                'url' => FULL_BASE_URL . $album['User']['moo_href'],
                                'id' =>  $album['User']['id'],
                        ...
                        if ($data['Activity']['target_id']): 
                            ...
                            if ($show_subject):
                                ...
                                $userAlbum = array (
                                    'user_url' => FULL_BASE_URL . $album['User']['moo_href'],
        ...
        case 'Event_Event': 
                    ...
                    if (isset($data['Activity']['parent_id']) && $data['Activity']['parent_id']):
                        ...
                        if($data['Activity']['action'] == 'event_item_detail_share') :
                            ...
                            $event = $eventModel->findById($data['Activity']['parent_id']);
                             ...
                             $target = array(
                                'url' => FULL_BASE_URL . $event['User']['moo_href'],
                                'id' =>  $event['User']['id'],
                            ...
                            if ($data['Activity']['target_id']): 
                                ...
                                if ($show_subject):
                                    ...
                                    $eventMore = array (
                                        'user_url' => FULL_BASE_URL . $event['User']['moo_href'],
                ...
                if($type == 'share_user') $items = array_merge($items,$eventMore);
        ...
        case 'Topic_Topic': 
            ...
            if($data['Activity']['action'] == 'topic_item_detail_share' ) : 
                    ...
                    if (isset($data['Activity']['parent_id']) && $data['Activity']['parent_id']): 
                     ...
                     if ($data['Activity']['target_id']): 
                            ...
                            if ($show_subject): //echo '<pre>';print_r($show_subject);die;
                                ...
                                $topicMore = array (
                                    'user_url' => FULL_BASE_URL . $topic['User']['moo_href'],
                ...
                if($type == 'share_user') $items = array_merge($items,$topicMore);
            ...
            if($data['Activity']['action'] == 'blog_create') :
                ...
                if($data['Activity']['action'] == 'blog_item_detail_share' ) :  
                    ...
                    if (isset($data['Activity']['parent_id']) && $data['Activity']['parent_id']): 
                        ...
                        $target = array(
                                'url' => FULL_BASE_URL . $blog['User']['moo_href'],
                                'id' =>  $blog['User']['id'],
                                'name' =>  $blog['User']['name'],
                                'type' =>  'User',
                                );
                        ...
                        if ($data['Activity']['target_id']):
                            ...
                            if ($show_subject):
                                ...
                                $blogArray = array (
                                    ...
                                    'id' => $blog["Blog"]['id'],
                                    'url' => FULL_BASE_URL . $blog['Blog']['moo_href'],
                                    'user_url' => FULL_BASE_URL . $blog['User']['moo_href'],
        ...
        case 'Group_Group':
            ...
            $groupMore = '';
                ...
                if($data['Activity']['action'] == 'group_item_detail_share' ) :
                    ...
                    $target = array(
                                'url' => FULL_BASE_URL . $group['User']['moo_href'],
                                'id' =>  $group['User']['id'],
                    ...
                    if ($data['Activity']['target_id']): 
                            ...
                            if ($show_subject): //echo '<pre>';print_r($show_subject);die;
                                ...
                                $groupMore = array (
                                    'user_url' => FULL_BASE_URL . $group['User']['moo_href'],
                ...
                if (!empty($data['UserTagging']['users_taggings'])) : 
                    ...
                    if($type == 'share_user') $items = array_merge($items,$groupMore);
    ...
    $feed['items'] = array(
        ...
        'likeCount' => $check_privacy_type && ((isset($groupTypeItem) && $groupTypeItem['is_member']) || (!isset($groupTypeItem)) ) ? $data['Activity']['like_count'] : '',
        'dislikeCount' => $check_privacy_type && ((isset($groupTypeItem) && $groupTypeItem['is_member']) || (!isset($groupTypeItem)) ) ? $data['Activity']['dislike_count'] : '',
        'commentCount' => $check_privacy_type && ((isset($groupTypeItem) && $groupTypeItem['is_member']) || (!isset($groupTypeItem)) ) ? $commentCount : '' ,
        'actor' => array (
                'url' => FULL_BASE_URL . $data['User']['moo_href'],
