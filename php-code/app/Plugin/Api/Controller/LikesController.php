 ...
 *
 */
class LikesController extends ApiAppController {
    ...
    public function delete() {
        ...
        $this->$model->id = $id;
        if (!empty($like) && $like['Like']['thumb_up'] == 1) { // user already liked this item
    ...
    public function view() {
        ...
        $users = $this->Like->getLikes($id, $type, null, null);
        if (!empty($users)) {
