...
<?php if ( $type == 'home' ): ?>
	...
	<a href="javascript:void(0)" class="pull-right mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored2 clearAllNotification"><?php echo __('Clear All Notifications')?></a>
	<?php endif; ?>
        <a href="javascript:void(0);" class="markAllNotificationAsRead pull-right mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored2"><?php echo __('Mark All As Read'); ?></a>	
<?php endif; ?>
<div class="clear"></div>
<?php 
...
?>
	<?php if ($view_more): ?>
		<?php $this->Html->viewMore($view_more_url,'notifications_list') ?>
	<?php endif; ?>
</ul>
<?php
endif;
