    ...
    <div class="content_center">
        ...
        <div class="ava_content">
            ...
            <div class="">
                ...
                <a id="submit-avatar" href="<?php echo $this->request->base; ?>/users/view/<?php echo $cuser['id']; ?>"; type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 submit-avatar hide"><span aria-hidden="true"><?php echo  __('Submit') ?></span>
                </a>
            </div>
        </div>
