            ...
            <div class="full_content">
                <div class="content_center">
                    <div class="edit-profile-section">
                        ...
                        <div class="col-md-9">
                            <div style="margin-top:10px"><input type="submit" value="<?php echo __('Save Changes'); ?>" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1"></div>
                        </div>
                    </div>
                </div>
            </div>
