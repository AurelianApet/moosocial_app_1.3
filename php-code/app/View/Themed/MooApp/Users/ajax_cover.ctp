...
<div class="modal-footer">
    <button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 save-cover"><span aria-hidden="true"><?php echo __('Save Cover Picture')?></span></button>
    <button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 save-cover" data-dismiss="modal"><span aria-hidden="true"><?php echo __('Cancel')?></span></button>
</div>
