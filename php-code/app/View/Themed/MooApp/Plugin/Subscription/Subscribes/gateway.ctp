    ...
    <div class="content_center">
        ...
        <?php echo $this->Session->flash('subscription');?>      
            ...
            <?php foreach($gateways as $gateway):
                ...
                if ($helper->checkSupportCurrency($currency_code) && (!$is_recurring || ($is_recurring && $helper->supportRecurring()) )):
            ?>
		            <form onSubmit="return submitGateway();" id="formGateway" method="post" action="<?php echo $this->request->base.$furl;?>gateway/">            
		                ...
		                <input type="submit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" value="<?php echo __( 'Pay with').' '.$gateway['name'];?>" />
		                <br/><br/>
		            </form>
            	<?php endif;?>
            <?php endforeach;?>
