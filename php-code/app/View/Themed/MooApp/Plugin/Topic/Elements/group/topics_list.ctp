...
if (!empty($topics) && count($topics) > 0) {
    ...
    foreach ($topics as $topic):
	 ...
	 <?php if(!empty( $ajax_view )): ?>
                ...
                <img src="<?php echo $this->request->webroot ?>theme/<?php echo $this->theme ?>/img/s.png" style="background-image:url(<?php echo $topicHelper->getImage($topic, array())?>)" class="topic-thumb" />
                </a>
            <?php else: ?>
            ...
            <div class="list_option">
                <div class="dropdown">
                    ...
                    <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="topic_edit_<?php echo $topic['Topic']['id']?>">
                        ...
                        <li class="mdl-menu__item"><a href="javascript:void(0);" class="ajaxLoadTopicEdit" data-url="<?php echo $this->request->webroot?>topics/group_create/<?php echo $topic['Topic']['id']?>"><?php echo __( 'Edit Topic'); ?></a></li>
                        <li class="mdl-menu__item"><a href="javascript:void(0);" class="deleteTopic" data-id="<?php echo $topic['Topic']['id']?>" data-group="<?php echo $group_id?>"><?php echo  __( 'Delete') ?></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
