...
<div class="bar-content full_content">
    <div class="blog_view">
     <div class="blog_thumb">
            <img height="180" style="background-image:url(<?php echo $topicHelper->getImage($topic, array())?>)" src="<?php echo $this->request->webroot ?>theme/<?php echo $this->theme ?>/img/s.png" />
        </div>
 ...
 ?>
	    ...
	    <h1><?php echo h($topic['Topic']['title'])?></h1>
            <div class="extra_info"><?php echo __( 'Posted in')?> 
                <a href="<?php echo $this->request->base?>/topics/index/<?php echo $topic['Topic']['category_id']?>/<?php echo seoUrl($topic['Category']['name'])?>"><strong><?php echo $topic['Category']['name']?></strong></a> <?php echo $this->Moo->getTime($topic['Topic']['created'], Configure::read('core.date_format'), $utz)?></div>
