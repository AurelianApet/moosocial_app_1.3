...
<ul class="list6" style="position:relative">
	...
	<li id="invite_friend">
        <div class="m_suggest mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            ...
            <label class="mdl-textfield__label"><?php echo __( 'Friends')?></label>
        </div> 
	...
	<li>
        ...
        <a href="#" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" id="sendButton"><?php echo __( 'Send Invitations')?></a>
