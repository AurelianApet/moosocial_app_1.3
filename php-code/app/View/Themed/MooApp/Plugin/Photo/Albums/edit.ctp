    ...
    <div class="content_center">
        ...
        <div class="box3">
            <div class="mo_breadcrumb">
                ...
                <a href="<?php echo $this->request->base?>/albums/view/<?php echo $album['Album']['id']?>" class="topButton mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored"><?php echo __( 'View Album')?></a>
            </div>
                ...
                <div align="center" style="margin-top: 30px">
                    <button type="submit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored"><?php echo __( 'Save Changes')?></button>
                        <?php if ( empty( $album['Album']['type'] ) ): ?>
                        <button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored deleteAlbum" data-id="<?php echo $album['Album']['id']?>">
                            <?php echo __( 'Delete Album')?>
                        </button>
                        <?php endif; ?>
                </div>
                    <div class='clear'></div>
