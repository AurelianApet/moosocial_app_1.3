    ...
    <div class="modal-body">
        <div class="bar-content full_content p_m_10">
			...
			<input type="hidden" name="type" value="<?php echo $type?>">
                    <input type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored" id="nextStep" value="<?php echo __( 'Save Photos')?>" style="display:none">
