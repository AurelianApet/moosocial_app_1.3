...
<div class="bar-content">
    <div class="content_center">
         <div class="mo_breadcrumb">
            ...
            <a id="share-new" data-target="#videoModal" data-toggle="modal" data-id="<?php echo $group_id?>" data-url="<?php echo $this->request->base ?>/videos/group_create" class="topButton mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1">
                <?php echo __( 'Share New Video')?></a>
