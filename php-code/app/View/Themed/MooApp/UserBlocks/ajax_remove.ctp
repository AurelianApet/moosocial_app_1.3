...
<div class="modal-footer">
    <form id="unBlockUserForm">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <a style="float:left" href="javascript:void(0)" data-uid="<?php echo $user['User']['id']?>" id="unBlockUserButton" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored"><?php echo __('Confirm')?></a>
                    <a style="float:left; margin-left:3px" href="javascript:void(0)" data-dismiss="modal" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1"><?php echo __('Cancel')?></a>
                </td>
            </tr>
        </table>
    </form>
