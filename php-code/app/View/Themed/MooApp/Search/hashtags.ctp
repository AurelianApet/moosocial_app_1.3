        ...
        <div class="box2">
            ...
            <div class='box_content'>
                <ul class="list2" id="global-search-filters">
                    <li <?php echo ($type == 'all')? 'class="current"':'' ?>><a href="<?php echo $this->request->base?>/search/hashtags/<?php echo $keyword?>" class="no-ajax"><?php echo __('All Results')?></a></li>
                    <?php if(!empty($activities)): ?>
                    <li <?php echo ($type == 'activities')? 'class="current"':'' ?>><a href="<?php echo $this->request->base?>/search/hashtags/<?php echo $keyword?>/tabs:activities" data-url="<?php echo $this->request->base?>/search/hashtags/<?php echo $keyword?>/activities" id="filter-activities" href="#"><?php echo __('Activities')?></a></li>
                        <?php
                    ...
                    <li <?php echo ($type == 'comments')? 'class="current"':'' ?>><a href="<?php echo $this->request->base?>/search/hashtags/<?php echo $keyword?>/tabs:comments" data-url="<?php echo $this->request->base?>/search/hashtags/<?php echo $keyword?>/comments" id="filter-comments" href="#"><?php echo __('Comments')?></a></li>
                    <?php endif; ?>
                ...
                <div id="search-content">
                    <?php if ( !empty( $activities ) ): ?>
                        ...
                        <div class="search-more">
                            <?php if(empty($filter)): ?>
                                <a href="javascript:void(0)" data-query="activities" class="globalSearchMore"><?php echo __('View More Results')?></a>
                            <?php else: ?>
                                <?php echo $this->Html->link(__('View More Results'),array('controller' => 'search','action' => 'hashtags',$keyword,'activities'),array('class' => '')) ?>
                            <?php endif; ?>
                        </div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <?php if ( !empty( $comments ) || !empty($activity_comments) ): ?>
                        <div class="head_search_item">
                            ...
                            <div class="search-more">
                                <?php if(empty($filter)): ?>
                                    <a href="javascript:void(0)" data-query="comments" class="globalSearchMore"><?php echo __('View More Results')?></a>
                                <?php else: ?>
                                    <?php echo $this->Html->link(__('View More Results'),array('controller' => 'search','action' => 'hashtags',$keyword,'comments'),array('class' => '')) ?>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <?php if ( !empty( $other_suggestion ) ): ?>
                        <?php foreach($other_suggestion as $k => $search):?>
                            ...
                            <div class="search-more">
                                <?php if(empty($filter)): ?>
                                    <a href="javascript:void(0)" data-query="<?php echo strtolower($k);?>" class="globalSearchMore"><?php echo __('View More Results')?></a>
                                <?php else: ?>
                                    <?php echo $this->Html->link(__('View More Results'),array('controller' => 'search','action' => 'hashtags',$keyword,strtolower($k)),array('class' => '')) ?>
                                <?php endif; ?>
                            </div>
                            </div>
                            <div class="clear"></div>
