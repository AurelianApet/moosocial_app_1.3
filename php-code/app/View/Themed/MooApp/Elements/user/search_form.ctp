...
<?php $this->getEventManager()->dispatch(new CakeEvent('View.Elements.User.searchForm.afterRender', $this)); ?>
                    <li style="margin-top:20px"><input type="button" value="<?php echo __('Search') ?>" id="searchPeople" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored"></li>
                </ul>
            </form>
        </div>
    </div>
