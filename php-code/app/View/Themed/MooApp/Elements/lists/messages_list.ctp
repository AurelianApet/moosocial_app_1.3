...
if ( !empty($conversations) )
{
	...
	<li <?php if ($conversation['ConversationUser']['unread']) echo 'class="unread"';?>>
		...
		<div class="comment">
			<a class="message_title"  href="<?php echo $this->request->base?>/conversations/view/<?php echo $conversation['Conversation']['id']?>"><b><?php echo h($conversation['Conversation']['subject'])?></b></a>
			...
			<div class="message_short_detail"><?php echo h($this->Text->truncate($conversation['Conversation']['message'], 85, array('exact' => false)))?></div>
		<a style="<?php if (!$conversation['ConversationUser']['unread']) echo 'display:none;' ?>" href="javascript:void(0)" data-id="<?php echo $conversation['Conversation']['id']?>" data-status="0" class="markMsgStaus tip mark_section" title="<?php echo __( 'Mark as Read')?>">
                        <i class="igicon-mark"></i>
                    </a>
                    <a style="<?php if ($conversation['ConversationUser']['unread']) echo 'display:none;' ?>" href="javascript:void(0)" data-id="<?php echo $conversation['Conversation']['id']?>" data-status="1" class="markMsgStaus tip mark_section" title="<?php echo __( 'Mark as unRead')?>">
                        <i class="igicon-unmark"></i>
                    </a>
		</div>
	</li>
<?php 
