...
<div class="dropdown edit-post-icon comment-option">
        <a id="comment_edit_<?php echo $comment['ActivityComment']['id']?>" class="cross-icon" data-toggle="dropdown">
            <i class="material-icons">more_vert</i>
        </a>
	<ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="comment_edit_<?php echo $comment['ActivityComment']['id']?>">		
		<li class="mdl-menu__item mdl-js-ripple-effect">
			<a href="javascript:void(0)" class="editActivityComment" data-activity-comment-id="<?php echo $comment['ActivityComment']['id']?>">
 ...
 ?>
		    ...
		    <a href="javascript:void(0)" data-id="<?php echo $comment['ActivityComment']['id']?>" data-type="core_activity_comment" data-status="1" id="core_activity_comment_l_<?php echo $comment['ActivityComment']['id']?>" class="comment-thumb likeActivity"><i class="material-icons md-18">thumb_up</i></a><span id="core_activity_comment_like_<?php echo $comment['ActivityComment']['id']?>">0</span>
        <?php if(empty($hide_dislike)): ?>
            <a href="javascript:void(0)" data-id="<?php echo $comment['ActivityComment']['id']?>" data-type="core_activity_comment" data-status="0" id="core_activity_comment_l_<?php echo $comment['ActivityComment']['id']?>" class="comment-thumb likeActivity"><i class="material-icons md-18">thumb_down</i></a><span id="core_activity_comment_dislike_<?php echo $comment['ActivityComment']['id']?>">0</span>
		<?php endif; ?>
        </div>
...
<?php else: ?>
        <li id="itemcomment_<?php echo $photoComment['Comment']['id']?>" <?php echo $this->Moo->getItemPhoto(array('User' => $photoComment['User']),array('prefix' => '50_square'), array('class' => 'user_avatar_small img_wrapper2'))?>
