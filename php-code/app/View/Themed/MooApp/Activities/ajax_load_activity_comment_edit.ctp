...
<div id="activity_comment_edit_<?php echo $activity_comment['ActivityComment']['id']?>">
	...
	<div id="activity_comment_preview_attach_<?php echo $activity_comment['ActivityComment']['id'];?>">
		...
		?>
			<span style="background-image:url(<?php echo $this->Moo->getImageUrl($activity_comment);?>)"><a class="removePhotoComment"  data-type="activity" data-id="<?php echo $activity_comment['ActivityComment']['id']?>" href="javascript:void(0);"><i class="icon-delete"></i></span></a>
		<?php endif;?>
	</div>
	<div class="edit-post-action">
		<a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored cancelEditActivityComment" href="javascript:void(0);" data-id="<?php echo $activity_comment['ActivityComment']['id'];?>"><?php echo __('Cancel');?></a> 
                <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored confirmEditActivityComment" href="javascript:void(0);" data-id="<?php echo $activity_comment['ActivityComment']['id'];?>"><?php echo __('Done Editing');?></a>
	</div>
</div>