    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="list_tabshare">
            ...
            <ul id="myTabDrop1-contents">
                <li class="active">
                    <a href="#me" role="tab" id="dropdown1-tab" data-toggle="tab" aria-controls="dropdown1" aria-expanded="false"><?php echo __('My Wall'); ?><span class="caret"></span></a>
                </li>
                <li class="">
                    <a href="#friend" role="tab" id="dropdown2-tab" data-toggle="tab" aria-controls="dropdown2" aria-expanded="true"><?php echo __('Friend Wall'); ?><span class="caret"></span></a>
                </li>
                <li class="">
                    <a href="#group" role="tab" id="dropdown3-tab" data-toggle="tab" aria-controls="dropdown3" aria-expanded="true"><?php echo __('Group Wall'); ?><span class="caret"></span></a>
                </li>
                <li class="">
                    <a href="#msg" role="tab" id="dropdown4-tab" data-toggle="tab" aria-controls="dropdown4" aria-expanded="true"><?php echo __('Messages'); ?><span class="caret"></span></a>
                </li>
                <li class="">
                    <a href="#email" role="tab" id="dropdown5-tab" data-toggle="tab" aria-controls="dropdown5" aria-expanded="true"><?php echo __('Email'); ?><span class="caret"></span></a>
                </li>
                <?php if (!empty($plugin)): ?>
                    <li class="sharethis">
                        <a href="#socialshare" role="tab" id="dropdown5-tab" data-toggle="tab" aria-controls="dropdown5" aria-expanded="true"><?php echo __('Share This'); ?><span class="caret"></span></a>
                    </li>
                <?php endif; ?>
            </ul>
        </li>
            ...
            <div class="userTagged">
                ...
                <div class="stt-action share-action">
                    ...
                    <div class="user-tagging-container">
                        <i data-toggle="tooltip" title="<?php echo __('Tag people in your post'); ?>" onclick="$('.userTagging-userTaggingOnShareForm').toggleClass('hidden')"><span class="material-icons">person_add</span></i>
                    </div>
                   
                    <input class=" mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored" type="button" id="shareBtn" name="share" value="<?php echo __('Share'); ?>" />
                </div>
            </div>
