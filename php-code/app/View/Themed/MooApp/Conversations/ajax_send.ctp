    ...
    <ul class="list6 list6sm2" style="position:relative">
        ...
        <li>
                ...
                <div class="col-sm-10">
                    ...
                    <a href="javascript:void(0);" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 " data-dismiss="modal"><?php echo __('Cancel')?>
                    </a>
                </div>
                 <div class="clear"></div>
            </li>
