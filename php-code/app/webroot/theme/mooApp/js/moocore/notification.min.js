...
b).hasClass("unread")&&"0"!=a("#notification_count").html()&&(d=parseInt(a(".notification_count").html())-1,0==d?a(".notification_count").remove():a(".notification_count").html(d),a("#notification_count").html(d),Tinycon.setBubble(d))})};return{init:function(){l&&(q(),r())},setUrl:function(a){f=a},setActive:function(a){l=a},setInterval:function(a){0<a&&(m=1E3*a)},removeNotification:g,initAjaxShow:function(){a("#notifications_list li").hover(function(){a(this).contents().find(".delete-icon").show()},
function(){a(this).contents().find(".delete-icon").hide()});a(".removeNotification").unbind("click");a(".removeNotification").click(function(){var b=a(this).data();g(b.id)});a(".clearAllNotification").unbind("click");a(".clearAllNotification").click(function(){a.get(mooConfig.url.base+"/notifications/ajax_clear");a(".notification_list").slideUp();a("#new_notifications").fadeOut();a("#notification_count").html("0");a(".notification_count").html("0");Tinycon.setBubble(0)});p.initMoreResults()},initNotification:function(){a("#notificationButton").unbind("click");
a("#notificationButton").click(function(){var b=a("#item_type").val(),d=a("#item_id").val();h.disableButton("notificationButton");a("#notificationButton").spin("small");a.post(mooConfig.url.base+"/notifications/ajax_save",a("#notificationForm").serialize(),function(e){h.enableButton("notificationButton");a("#notificationButton").spin(!1);e=a.parseJSON(e);1==e.result?(a(".error-message").hide(),1==e.is_stop?a("#stop_notification_"+b+d).html(k.__("turn_on_notifications")):a("#stop_notification_"+b+
d).html(k.__("stop_notifications")),n.alert(e.message),a("#portlet-config").modal("hide"),a("#themeModal").modal("hide")):(a(".error-message").show(),a(".error-message").html(e.message))})});return!1},initRemoveNotification:function(){a(".removeNotification").unbind("click");a(".removeNotification").on("click",function(){var b=a(this).data();g(b.id)})},initMarkRead:function(){a(".markMsgStatus").unbind("click");a(".markMsgStatus").click(function(){var b=a(this).data(),d=a(this);c.post({url:mooConfig.url.base+
...
a(".mark_unread").show(),a(".notification_count").remove(),a("#notification_count").html("0"),a("#notifications_list li").each(function(b,c){var d=a(c).find("a:first");d.hasClass("unread")&&d.removeClass("unread")}))})});a(".clearAllNotifications").unbind("click");a(".clearAllNotifications").click(function(){c.post({url:mooConfig.url.base+"/notifications/clear_all_notifications",data:{}},function(b){a(".notification_count").remove();a("#notification_count").html("0");a("#notifications_list").html(b);
