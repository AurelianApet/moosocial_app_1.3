        ...
        var uploader = new mooFileUploader.fineUploader({
            ...
            callbacks: {
                ...
                onComplete: function(id, fileName, response) {
                    ...
                    Android.setAvatar(response.avatar_100);
                }
            }
        });
    }
        ...
        var uploader = new mooFileUploader.fineUploader({
            ...
            callbacks: {
                ...
                onComplete: function(id, fileName, response) {
                    ...
                    Android.setCover(mooConfig.url.full + response.photo);
                }
            }
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (element.data('follow'))
                    {
                        ...
                        element.find('.material-icons').html('rss_feed');
                    }
                    else
                    {
                        element.data('follow',1);
                        element.find('.material-icons').html('check');
                    }
                }
            });
        });
    ...
    var initOnUserIndex = function(){
        ...
        $("#searchPeople").click(function(){
            ...
            $.post(mooConfig.url.base + '/users/ajax_browse/search', $("#filters").serialize(), function(data){
                ...
                $('.user_search_form').removeClass('open');
            });
