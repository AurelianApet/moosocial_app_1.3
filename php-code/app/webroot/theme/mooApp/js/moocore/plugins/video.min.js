...
data:a("#createForm").serialize()},function(b){d.enableButton("fetchButton");a("#fetchForm").slideUp();a("#videoForm").html(b)})});return!1});componentHandler.upgradeAllRegistered()},initAfterFetch:function(){a("#saveBtn").unbind("click");a("#saveBtn").click(function(){a(this).addClass("disabled");f.createItem("videos",!0)});e();componentHandler.upgradeAllRegistered()},initOnView:function(){e()},initOnListing:function(){f.initMoreResults();e();a(".ajaxLoadPage").unbind("click");a(".ajaxLoadPage").on("click",
function(){var b=a(this).data();k.loadPage("videos",b.url)})}}});