...
c)})},n=function(){a(".inviteMore").parent().unbind("click");a(".inviteMore").parent().click(function(){var b=a(this).find("a").data();a("#langModal .modal-content").html("");a("#langModal .modal-content").spin("small");a("#langModal .modal-content").load(b.url,function(){a("#langModal .modal-content").spin(!1);a("#langModal").modal("show")})})};return{initOnCreate:function(){new d.fineUploader({element:a("#select-0")[0],multiple:!1,text:{uploadButton:'<div class="item_thumb_select">&nbsp;</div>'},
validation:{allowedExtensions:mooConfig.photoExt,sizeLimit:mooConfig.sizeLimit},request:{endpoint:mooConfig.url.base+"/event/event_upload/avatar"},callbacks:{onError:l.errorHandler,onComplete:function(b,d,e){a("#photo").val(e.filename);a("#item-avatar").css("background-image","url("+e.thumb+")");a("#item-avatar").show();a("#photo").val(e.file_path)}}});a(".datepicker").pickadate({monthsFull:[b.__("january"),b.__("february"),b.__("march"),b.__("april"),b.__("may"),b.__("june"),b.__("july"),b.__("august"),
b.__("september"),b.__("october"),b.__("november"),b.__("december")],monthsShort:[b.__("jan"),b.__("feb"),b.__("mar"),b.__("apr"),b.__("may"),b.__("jun"),b.__("jul"),b.__("aug"),b.__("sep"),b.__("oct"),b.__("nov"),b.__("dec")],weekdaysFull:[b.__("sunday"),b.__("monday"),b.__("tuesday"),b.__("wednesday"),b.__("thursday"),b.__("friday"),b.__("saturday")],weekdaysShort:[b.__("sun"),b.__("mon"),b.__("tue"),b.__("wed"),b.__("thu"),b.__("fri"),b.__("sat")],today:b.__("today"),clear:b.__("clear"),format:"yyyy-mm-dd",
close:!1,onClose:function(){""!=a("#to").val()&&a("#from").val()>a("#to").val()&&(e.alert(b.__("to_date_must_be_greater_than_from_date")),a("#to").val(""));if(""!=a("#to").val()&&a("#from").val()>=a("#to").val()){var c=parseInt(a("#from_time_root .picker__list-item--selected").attr("data-pick")),d=parseInt(a("#to_time_root .picker__list-item--selected").attr("data-pick"));""!=a("#to_time").val()&&d<=c&&(e.alert(b.__("to_time_must_be_greater_than_from_time")),a("#to").val(""),a("#to_time").val(""))}}});
a(".timepicker").pickatime({clear:b.__("clear"),format:"24"==mooConfig.time_format?"H:i":"h:i A",onClose:function(c){if(""!=a("#to").val()&&a("#from").val()>=a("#to").val()){c=parseInt(a("#from_time_root .picker__list-item--selected").attr("data-pick"));var d=parseInt(a("#to_time_root .picker__list-item--selected").attr("data-pick"));""!=a("#to_time").val()&&d<=c&&(e.alert(b.__("to_time_must_be_greater_than_from_time")),a("#to").val(""),a("#to_time").val(""))}}});a("#saveBtn").unbind("click");a("#saveBtn").click(function(){a(this).addClass("disabled");
null!==tinyMCE.activeEditor&&a("#editor").val(tinyMCE.activeEditor.getContent());g.createItem("events",!0)});f()},initOnView:function(){f();n()},initOnListing:function(){g.initMoreResults();f()},initOnInvitePopup:function(){m()}}});