...
mooConfig.isMobile||u.setImage(c.avatar);Android.setAvatar(c.avatar_100)}}})},initAddFriend:function(){a("#sendReqAddFriendBtn").unbind("click");a("#sendReqAddFriendBtn").click(function(){var b=a(this).data().uid;a("#sendReqAddFriendBtn").spin("small");g.disableButton("sendReqAddFriendBtn");a.post(mooConfig.url.base+"/friends/ajax_sendRequest",a("#addFriendForm").serialize(),function(d){a(".suggestion_block").length&&(a(".suggestion_block #addFriend_"+b).parents("li:first").remove(),0==a(".suggestion_block li").length&&
a(".suggestion_block").remove());g.enableButton("sendReqAddFriendBtn");a("#themeModal").modal("hide");a("#addFriend_"+b).parents("div.user-idx-item").append('<a href="'+mooConfig.url.base+"/friends/ajax_cancel/"+b+'" id="cancelFriend_'+b+'" class="add_people" title="'+c.__("cancel_a_friend_request")+'"><i class="material-icons">clear</i>'+c.__("cancel_request")+"</a>");a("#addFriend_"+b).remove();a("#blogAddFriend").length&&(a("#blogAddFriend").parents(".blog_view_leftnav").append('<li><a href="'+
mooConfig.url.base+"/friends/ajax_cancel/"+b+'" id="blogCancelFriend" class="" title="'+c.__("cancel_a_friend_request")+'"><i class="material-icons icon-small">clear</i>'+c.__("cancel_request")+"</a></li>"),a("#blogAddFriend").parents("li:first").remove());a("#userAddFriend").length&&(a("#userAddFriend").parents(".profile-action").append('<a id="userCancelFriend" href="'+mooConfig.url.base+"/friends/ajax_cancel/"+b+'" class="topButton button button-action" title="'+c.__("cancel_a_friend_request")+
'"><i class="visible-xs visible-sm material-icons">clear</i><i class="hidden-xs hidden-sm">'+c.__("cancel_request")+"</i></a>"),a("#userAddFriend").remove());location.reload()});return!1})},initBirthdayPopup:function(){a(".more-birthday-email").unbind("click");a(".more-birthday-email").click(function(){a("#langModal").modal("show")&&a("#langModal").modal("hide")});a(".postFriendWall").unbind("click");a(".postFriendWall").click(function(){var b=a(this).data("id"),d=a(this),f=a("#message_"+b).val();
""!=a.trim(f)&&(g.disableButton("status_btn_"+b),a.post(mooConfig.url.base+"/activities/send_birthday_wish",a("#wallForm_"+b).serialize(),function(e){e=a.parseJSON(e);g.enableButton("status_btn_"+b);a("#message_"+b).val("");e.success&&(g.enableButton("status_btn_"+b),d.parent(".birthday-wish").html("<div style='padding:5px 0px;'>"+c.__("birthday_wish_is_sent")+"</div>"))}))})},initEditCoverPicture:function(){function b(a,b,d){window.URL=window.URL||window.webkitURL;a=d.getFile(a);d=new Image;var e=
{};d.onerror=function(a){e.error=c.__("cannot_determine_dimensions_for_image_may_be_too_large")};d.onload=function(){e={width:this.width,height:this.height};var a=e.height>=b[1];e.width>=b[0]&&a?f.uploadStoredFiles():(f.clearStoredFiles(),n.alert(c.__("please_choose_an_image_that_s_at_least_400_pixels_wide_and_at_least_150_pixels_tall")))};d.src=window.URL.createObjectURL(a)}var d;mooConfig.isMobile||a("#cover-img").Jcrop({aspectRatio:4,onSelect:r,minSize:[400,200],boxWidth:570},function(){d=this});
var f=new p.fineUploader({element:a("#select-1")[0],multiple:!1,autoUpload:!1,text:{uploadButton:'<div class="upload-section"><i class="material-icons">photo_camera</i>'+c.__("drag_or_click_here_to_upload_photo")+"</div>"},validation:{allowedExtensions:mooConfig.photoExt,sizeLimit:mooConfig.sizeLimit},request:{endpoint:mooConfig.url.base+"/upload/cover"},callbacks:{onSubmit:function(a,d){return b(a,[400,150],this)},onError:q.errorHandler,onComplete:function(b,c,f){a("#cover_img_display").attr("src",
f.cover);mooConfig.isMobile?a("#cover_wrapper img").attr("src",f.photo):d.setImage(f.photo);Android.setCover(mooConfig.url.full+f.photo)}}})},initEditProfilePicture:function(){var b;mooConfig.isMobile?a(".modal-footer").addClass("hide"):a("#av-img2").Jcrop({aspectRatio:1,onSelect:r,minSize:[180,180],boxWidth:570},function(){b=this});new p.fineUploader({element:a("#select-0")[0],multiple:!1,text:{uploadButton:'<div class="upload-section"><i class="material-icons">photo_camera</i>'+c.__("drag_or_click_here_to_upload_photo")+
"</div>"},validation:{allowedExtensions:mooConfig.photoExt,sizeLimit:mooConfig.sizeLimit},request:{endpoint:mooConfig.url.base+"/upload/avatar"},callbacks:{onError:q.errorHandler,onComplete:function(d,c,e){a("#av-img").attr("src",e.avatar_mini);mooConfig.isMobile?a("#avatar_wrapper img").attr("src",e.avatar):b.setImage(e.avatar);a("#member-avatar").attr("src",e.thumb);Android.setAvatar(e.avatar_100)}}})},initRemoveFriend:function(){a("#removeFriendButton").unbind("click");a("#removeFriendButton").click(function(){var b=
a(this).data().uid;g.disableButton("removeFriendButton");a.post(mooConfig.url.base+"/friends/ajax_removeRequest",a("#removeFriendForm").serialize(),function(d){g.enableButton("removeFriendButton");a("#themeModal").modal("hide");d=a("#removeFriend_"+b).parents("li:first");var c=d.parents('li[id^="activity_"]');d.remove();c.remove();location.reload()});return!1})},initOnProfileEdit:function(){a(".multi").multiSelect({selectAll:!1,noneSelected:"",oneOrMoreSelected:c.__("per_selected")});a("#checkButton").unbind("click");
a("#checkButton").click(function(){z()})},initOnUserList:function(){a("#list-content li").hover(function(){a(this).contents().find(".delete-icon").show()},function(){a(this).contents().find(".delete-icon").hide()});v();B();D();t.initMoreResults()},initAjaxRequest:function(){a(".respondRequest").unbind("click");a(".respondRequest").on("click",function(){var b=a(this).data();if(0<a("#friend_request_count").length){var d=a("#friend_request_count").html(),d=parseInt(d-1);0>=d?a("#friend_request_count").parents("li:first").remove():
a("#friend_request_count").html(d)}a.post(mooConfig.url.base+"/friends/ajax_respond",{id:b.id,status:b.status},function(d){a("#request_"+b.id).html(d)})})},initShowAlbums:function(){a(".showAlbums").unbind("click");a(".showAlbums").on("click",function(){E(a(this).data("userId"))})},initRespondRequest:v,initOnUserIndex:function(){a(".multi").multiSelect({selectAll:!1,noneSelected:"",oneOrMoreSelected:c.__("per_selected")});a("#searchPeople").unbind("click");a("#searchPeople").click(function(){a("#everyone a").spin("tiny");
a("#browse .current").removeClass("current");a("#everyone").addClass("current");a.post(mooConfig.url.base+"/users/ajax_browse/search",a("#filters").serialize(),function(b){a("#everyone a").spin(!1);a("#list-content").html(b);w.registerOverlay();componentHandler.upgradeAllRegistered();a(".user_search_form").removeClass("open")})})},initOnUserProfile:function(){a(".deactiveMyAccount").unbind("click");a(".deactiveMyAccount").on("click",function(){n.confirm(c.__("confirm_deactivate_account"),mooConfig.url.base+
"/users/deactivate")});a(".deleteMyAccount").unbind("click");a(".deleteMyAccount").on("click",function(){n.confirm(c.__("confirm_delete_account"),mooConfig.url.base+"/users/request_deletion")});a("#save_profile").click(function(b){b.preventDefault();button=a(this);button.addClass("disabled");x.post({url:mooConfig.url.base+"/users/ajax_save_profile",data:jQuery("#form_edit_user").serialize()},function(b){b=a.parseJSON(b);b.status?location.reload():(button.removeClass("disabled"),a(".error-message").show(),
a(".error-message").html(b.message))});return!1})},initOnCloseNetworkSignup:function(b){a("#submitFormsignup").click(function(){a("#step1Box").spin("small");a("#submitFormsignup").attr("disabled","disabled");a.post(mooConfig.url.base+"/users/ajax_signup_step1",a("#regForm").serialize(),function(b){a("#step1Box").spin(!1);0<b.indexOf("mooError")?(a("#regError").fadeIn(),a("#regError").html(b),a("#submitFormsignup").removeAttr("disabled")):(a("#regError").fadeOut(),a("#regFields").append(b),a("#captcha").fadeIn(),
a("#step1Box").remove(),a(".tip").tipsy({html:!0,gravity:"s"}),a(".multi").multiSelect({selectAll:!1,noneSelected:"",oneOrMoreSelected:c.__("per_selected")}))})});a("#step2Submit").click(function(){if(a("#tos").is(":checked")){var d=!1;a("#step2Box").spin("small");a("#step2Submit").attr("disabled","disabled");a.post(mooConfig.url.base+"/users/ajax_signup_step2",a("#regForm").serialize(),function(c){a("#step2Box").spin(!1);var e="";try{e=JSON.parse(c),d=!0}catch(G){d=!1}d?e.redirect&&(window.location=
e.redirect):""!=c?(a("#regError").fadeIn(),a("#regError").html(c),a("#step2Submit").removeAttr("disabled"),b&&grecaptcha.reset()):window.location=mooConfig.url.webroot})}else a("#regError").fadeIn(),a("#regError").html(c.__("you_have_to_agree_with_term_of_service"))})},resendValidationLink:function(){a("#resend_validation_link").unbind("click");a("#resend_validation_link").on("click",function(){a.post(mooConfig.url.base+"/users/resend_validation",{},function(a){n.alert(c.__("validation_link_has_been_resend"))})})},
initOnSocialRegistration:function(b,c){a("#step2Submit").click(function(){a("#tos").is(":checked")?(a("#step2Box").spin("small"),a("#step2Submit").attr("disabled","disabled"),a.post(mooConfig.url.base+"/social/auths/ajax_signup_step2/"+c,a("#regForm").serialize(),function(c){a("#step2Box").spin(!1);var d="",f=!1;try{d=JSON.parse(c),f=!0}catch(H){f=!1}f?d.redirect&&(window.location=d.redirect):""!=c?(a("#regError").fadeIn(),a("#regError").html(c),a("#step2Submit").removeAttr("disabled"),b&&grecaptcha.reset()):
window.location=mooConfig.url.base})):(a("#regError").fadeIn(),a("#regError").html("You have to agree with term of service"))})},initOnUserView:function(){a("#themeModal").on("click"," .save-avatar",function(){a("#avatar_wrapper").spin("large");var b=a("#themeModal");a.post(mooConfig.url.base+"/upload/thumb",{x:h,y:k,w:l,h:m},function(c){b.modal("hide");""!=c&&(c=a.parseJSON(c),a("#member-avatar").attr("src",c.thumb),a("#av-img").attr("src",c.avatar_mini))})});a("#themeModal").on("click"," .save-cover",
function(){var b=a("#themeModal");a("#cover_wrapper").spin("large");var c=a("#cover_wrapper .jcrop-holder").width(),f=a("#cover_wrapper .jcrop-holder").height();a.post(mooConfig.url.base+"/upload/thumb_cover",{x:h,y:k,w:l,h:m,jcrop_width:c,jcrop_height:f},function(c){b.modal("hide");""!=c&&(c=a.parseJSON(c),a("#cover_img_display").attr("src",c.thumb))})})},initBlockUser:function(){a("#blockUserButton").unbind("click");a("#blockUserButton").click(function(){a("#blockUserButton").spin("small");g.disableButton("blockUserButton");
...
return!1})},initSearchFriend:function(b){a("#search_friend").unbind("keyup");a("#search_friend").keyup(function(){F(function(){url=b?mooConfig.url.base+"/users/profile_user_friends/"+b:mooConfig.url.base+"/users/ajax_browse/home";a.post(url,{is_search:!0,search:a("#search_friend").val()},function(b){a("#list-content").html(b);t.initMoreResults()})},200)})},loadProfileType:function(b){a("#profile_type_id").change(function(){var d=a("#profile_type_id").val();a.get(mooConfig.url.base+"/users/ajax_loadfields/"+
d+"/"+b,function(b){a(".custom-field").html(b);a(".multi").multiSelect({selectAll:!1,noneSelected:"",oneOrMoreSelected:c.__("per_selected")})})})}}});