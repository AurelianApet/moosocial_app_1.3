...
(function (root, factory) {
    ...
    var closeMenuProfileWhenClick = function(){
        $('.profile_plg_menu li.dropdown a').click(function(){
            $('.is-upgraded').removeClass('is-visible');
        });
    }
    var initMtEvent = function(){
         $('.cat_select_dropdown ul a .text').click(function(){
                var textCat = $(this).text();
                $('.cat_select_dropdown > a .text').html(textCat);
            });            
            $('#themeModal').on('shown.bs.modal', function (e) {               
                componentHandler.upgradeAllRegistered();
            });
            $('#videoModal').on('shown.bs.modal', function (e) {
                componentHandler.upgradeAllRegistered();
            });
            $('#langModal').on('shown.bs.modal', function (e) {
                componentHandler.upgradeAllRegistered();
            });
    }
    return{
